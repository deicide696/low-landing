...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center relative overflow-hidden px-6">
      ...
      {/* Gradient blob */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 h-[500px] w-[800px] rounded-full bg-gradient-to-b from-blue-500/20 to-transparent blur-3xl pointer-events-none" />
      ...
      >
        <div className="glass-dark rounded-2xl p-8 border border-white/5">
          ...
          <div className="flex flex-col items-center mb-8 gap-2">
            <Link to="/">
              <Logo className="w-24" imgClassName="object-contain w-full h-full brightness-0 invert hover:opacity-80 transition-opacity" />
            </Link>
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Inicia sesión para acceder a tu automatización
            </p>
          </div>
          ...
          <div className="mt-4 text-center">
            <Link to="/" className="text-xs text-slate-600 hover:text-slate-400 transition-colors inline-flex items-center gap-1">
              ← Volver al inicio
            </Link>
          </div>
        </div>
